        ...
        <div className="hidden md:block">
          <div className="card card-hover">
            <div className="card-body">
              <h1 className="text-2xl font-semibold text-gray-900 mb-2">Bienvenido a Tesoros del Chocó</h1>
              <p className="text-gray-600">Inicia sesión o crea tu cuenta para comprar artesanías o publicar tus productos como vendedor.</p>
