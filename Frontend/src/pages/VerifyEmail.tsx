          ...
          <div className="hidden md:block">
            <div className="card card-hover">
              <div className="card-body">
                <h1 className="text-2xl font-semibold mb-2 font-display">Verificar tu email</h1>
                <p className="opacity-80">Ingresa el código de verificación que te enviamos.</p>
              </div>
            </div>
          </div>
          <div className="card card-hover">
              ...
              <form className="space-y-4" onSubmit={form.handleSubmit}>
                ...
                <div className="text-center space-y-2">
                  <div className="text-sm">
                    ...
                    >
                      {seconds > 0 ? `Reenviar en ${timeDisplay}` : 'Reenviar código'}
                    </button>
                  </div>
                  <div className="text-sm">
