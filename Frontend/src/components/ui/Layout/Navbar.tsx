                    ...
                    <div className='absolute right-0 mt-2 w-96 bg-white glass rounded-2xl shadow-2xl z-50 overflow-hidden'>
                            ...
                            >
                              ...
                              <div className='flex-1 min-w-0'>
                                ...
                                <div className='mt-1 flex items-center gap-3'>
                                  ...
                                  <span className='text-sm font-semibold text-(--color-terracotta-suave)'>
                      ...
                      <div className='p-4 border-t bg-gray-50/60'>
                        <div className='flex items-center justify-between text-sm mb-3'>
                          ...
                          <span className='text-lg font-bold text-(--color-marron-cacao)'>
              ...
              {user ? (
                <div className='flex items-center gap-3'>
                  <div className='hidden sm:flex flex-col items-end leading-tight'>
                    <span className='text-sm font-medium text-(--color-marron-cacao)'>
                      {user.nombre || user.email}
                    </span>
                    <div className='flex items-center gap-2'>
                      <span className='text-xs opacity-80 capitalize text-(--color-marron-cacao)'>
                        {user.role}
                      </span>
                      {user.role === 'vendedor' && (
                        <span
                          className={`badge text-[10px] ${user.vendedor_estado === 'aprobado' ? 'badge-success' : user.vendedor_estado === 'pendiente' ? 'badge-warning' : 'badge-danger'}`}
                        >
                ...
                <div className='flex items-center gap-1 sm:gap-2'>
                  ...
                  <Link
                    to='/login'
                    className='sm:hidden p-2 rounded-lg hover:bg-(--color-marfil) nav-auth-icon'
              ...
              <div className='px-3 pt-3 pb-4 space-y-2'>
                ...
                {user?.role === 'comprador' && (
                  <Link
                    ...
                    className='block px-3 py-2 rounded-full text-base transition-colors hover:bg-gray-100'
                  >
                    Carrito{' '}
                    {cartCount > 0 && (
                ...
                {user && (
                  <div className='pt-3 border-t mt-3 border-(--color-border) flex items-center justify-between'>
                    <div className='flex items-center gap-2'>
                      <div className='w-8 h-8 rounded-full bg-(--color-terracotta-suave) text-white flex items-center justify-center text-sm font-bold'>
                        {userInitial}
                      </div>
                      <div>
                        <div className='text-sm font-medium text-(--color-marron-cacao)'>
                          {user.email}
                        </div>
                        <div className='text-xs opacity-80 capitalize text-(--color-marron-cacao)'>
                          {user.role}
                        </div>
                      </div>
                    </div>
