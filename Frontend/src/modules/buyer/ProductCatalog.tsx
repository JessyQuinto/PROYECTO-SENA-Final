      ...
      <div className='container py-8'>
        <div className='mb-8'>
          ...
          <p className='opacity-80'>
            Descubre productos únicos hechos por artesanos del Chocó
          </p>
        </div>
  ...
  return (
    <div className='container py-8'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-4 gap-6'>
        {/* Filtros */}
        <div
          className={`lg:col-span-1 ${showFiltersMobile ? '' : 'hidden'} lg:block`}
        >
          <Card>
        ...
        <div className='min-w-0 lg:col-span-3'>
          ...
          {filteredProducts.length === 0 ? (
            ...
            <div
              className={`grid ${twoColsMobile ? 'grid-cols-2' : 'grid-cols-1'} sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 items-stretch content-start`}
            >
