    ...
    (async () => {
      ...
      const [{ data }, { data: ship }] = await Promise.all([
        supabase
          .from('orders')
          .select(
            `id,total,estado,created_at,comprador_id,invoice_number,
    ...
    <div className='container py-8'>
      <div className='flex items-center justify-between mb-6'>
        ...
        <div className='flex items-center gap-2'>
          ...
          >
            <Icon
              category='Archivos e imagenes'
              name='StreamlineInterfaceDownloadButton2ArrowBottomDownDownloadInternetNetworkServerUpload'
              className='w-4 h-4'
            />
            Imprimir
          </button>
      ...
      <div
        ref={receiptRef}
        id='receiptRoot'
        className='grid grid-cols-1 lg:grid-cols-3 gap-6 print:grid-cols-3'
      >
          ...
          <div className='card-body space-y-3'>
            ...
            <p className='text-xs text-gray-500 flex items-center gap-2'>
              <Icon
                ...
                className='w-3 h-3'
              />
              Este es un comprobante electrónico generado para el flujo
              educativo. Conserva este número de pedido para consultas.
            </p>
          </div>
        </div>
      </div>
