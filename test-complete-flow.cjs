...
async function testCompleteFlow() {
  try {
    console.log('=== Tesoros Chocó API - Prueba Completa del Flujo Vendedor ===\n');
    ...
    const createProductResponse = await axios.post(
      ...
      {
        nombre: 'Producto de prueba - Flujo Completo',
        descripcion: 'Producto creado desde Node.js para prueba completa del flujo vendedor',
        precio: 150000,
        stock: 5,
    ...
    const updateProductResponse = await axios.put(
      ...
      {
        nombre: 'Producto de prueba - Actualizado (Flujo Completo)',
        descripcion: 'Producto actualizado desde Node.js para prueba completa del flujo vendedor',
        precio: 175000,
        stock: 3
      },
      {
    ...
    console.log('   Respuesta:', shipOrderItemResponse.data);
    ...
    console.log('- Marcar Order Item como Enviado: ✅');
    ...
    console.log('\nResumen de resultados hasta el error:');
    console.log('- Health Check: ✅');
    console.log('- Autenticación: ✅');
    console.log('- Post-Signup: ✅');
    console.log('- Creación de Producto: ✅');
